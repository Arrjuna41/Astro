...
I created a method which takes in all the information and outputs two plots (Height vs Time, Height vs Horizontal Trajectory) to show the motion of the projectile. 
