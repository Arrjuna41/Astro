...
radius_list = radius * Np.random.uniform( 0.1 * solar_radius, 3 * solar_radius, amount)
...
mat.xscale('log')
mat.yscale('log')
mat.scatter(Np.log10(lum_list / solar_lum), Np.log10(temp_list / solar_kelvin), c = temp_list, cmap='coolwarm')
